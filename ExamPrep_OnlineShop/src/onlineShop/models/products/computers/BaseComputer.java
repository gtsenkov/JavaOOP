...
public abstract class BaseComputer extends BaseProduct implements Computer {
    ...
    public Component removeComponent(String componentType) {
        ...
        return components.remove(index); //returns the collection after removal
    }
    ...
    public Peripheral removePeripheral(String peripheralType) {
        if (peripherals.stream().noneMatch(p -> p.getClass().getSimpleName()
        ...
        return peripherals.remove(index); //returns the collection after removal
    }
